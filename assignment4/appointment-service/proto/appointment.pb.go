...
const file_appointment_proto_rawDesc = "" +
	"\n" +
	"\x11appointment.proto\x12\x05proto\"o\n" +
	...
	"\fappointments\x18\x01 \x03(\v2\x1a.proto.AppointmentResponseR\fappointments2\xda\x02\n" +
	"\x12AppointmentService\x12P\n" +
	"\x11CreateAppointment\x12\x1f.proto.CreateAppointmentRequest\x1a\x1a.proto.AppointmentResponse\x12J\n" +
	"\x0eGetAppointment\x12\x1c.proto.GetAppointmentRequest\x1a\x1a.proto.AppointmentResponse\x12S\n" +
	"\x10ListAppointments\x12\x1e.proto.ListAppointmentsRequest\x1a\x1f.proto.ListAppointmentsResponse\x12Q\n" +
	"\x17UpdateAppointmentStatus\x12\x1a.proto.UpdateStatusRequest\x1a\x1a.proto.AppointmentResponseBUZSgithub.com/CoffeeSi/golang2AITU/assignment4/appointment-service/proto;appointmentpbb\x06proto3"
...
var file_appointment_proto_goTypes = []any{
	(*CreateAppointmentRequest)(nil), // 0: proto.CreateAppointmentRequest
	(*GetAppointmentRequest)(nil),    // 1: proto.GetAppointmentRequest
	(*ListAppointmentsRequest)(nil),  // 2: proto.ListAppointmentsRequest
	(*UpdateStatusRequest)(nil),      // 3: proto.UpdateStatusRequest
	(*AppointmentResponse)(nil),      // 4: proto.AppointmentResponse
	(*ListAppointmentsResponse)(nil), // 5: proto.ListAppointmentsResponse
}
var file_appointment_proto_depIdxs = []int32{
	4, // 0: proto.ListAppointmentsResponse.appointments:type_name -> proto.AppointmentResponse
	0, // 1: proto.AppointmentService.CreateAppointment:input_type -> proto.CreateAppointmentRequest
	1, // 2: proto.AppointmentService.GetAppointment:input_type -> proto.GetAppointmentRequest
	2, // 3: proto.AppointmentService.ListAppointments:input_type -> proto.ListAppointmentsRequest
	3, // 4: proto.AppointmentService.UpdateAppointmentStatus:input_type -> proto.UpdateStatusRequest
	4, // 5: proto.AppointmentService.CreateAppointment:output_type -> proto.AppointmentResponse
	4, // 6: proto.AppointmentService.GetAppointment:output_type -> proto.AppointmentResponse
	5, // 7: proto.AppointmentService.ListAppointments:output_type -> proto.ListAppointmentsResponse
	4, // 8: proto.AppointmentService.UpdateAppointmentStatus:output_type -> proto.AppointmentResponse
