...
const file_doctor_proto_rawDesc = "" +
	"\n" +
	"\fdoctor.proto\x12\x14doctor_service.proto\"p\n" +
	...
	"\adoctors\x18\x01 \x03(\v2$.doctor_service.proto.DoctorResponseR\adoctors2\xaf\x02\n" +
	"\rDoctorService\x12_\n" +
	"\fCreateDoctor\x12).doctor_service.proto.CreateDoctorRequest\x1a$.doctor_service.proto.DoctorResponse\x12Y\n" +
	"\tGetDoctor\x12&.doctor_service.proto.GetDoctorRequest\x1a$.doctor_service.proto.DoctorResponse\x12b\n" +
	"\vListDoctors\x12(.doctor_service.proto.ListDoctorsRequest\x1a).doctor_service.proto.ListDoctorsResponseBHZFgithub.com/CoffeeSi/golang2AITU/assignment2/doctor-service/proto;protob\x06proto3"
...
var file_doctor_proto_goTypes = []any{
	(*CreateDoctorRequest)(nil), // 0: doctor_service.proto.CreateDoctorRequest
	(*GetDoctorRequest)(nil),    // 1: doctor_service.proto.GetDoctorRequest
	(*ListDoctorsRequest)(nil),  // 2: doctor_service.proto.ListDoctorsRequest
	(*DoctorResponse)(nil),      // 3: doctor_service.proto.DoctorResponse
	(*ListDoctorsResponse)(nil), // 4: doctor_service.proto.ListDoctorsResponse
}
var file_doctor_proto_depIdxs = []int32{
	3, // 0: doctor_service.proto.ListDoctorsResponse.doctors:type_name -> doctor_service.proto.DoctorResponse
	0, // 1: doctor_service.proto.DoctorService.CreateDoctor:input_type -> doctor_service.proto.CreateDoctorRequest
	1, // 2: doctor_service.proto.DoctorService.GetDoctor:input_type -> doctor_service.proto.GetDoctorRequest
	2, // 3: doctor_service.proto.DoctorService.ListDoctors:input_type -> doctor_service.proto.ListDoctorsRequest
	3, // 4: doctor_service.proto.DoctorService.CreateDoctor:output_type -> doctor_service.proto.DoctorResponse
	3, // 5: doctor_service.proto.DoctorService.GetDoctor:output_type -> doctor_service.proto.DoctorResponse
	4, // 6: doctor_service.proto.DoctorService.ListDoctors:output_type -> doctor_service.proto.ListDoctorsResponse
