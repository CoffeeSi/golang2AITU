...
const file_appointment_proto_rawDesc = "" +
	"\n" +
	"\x11appointment.proto\x12\x19appointment_service.proto\"o\n" +
	...
	"\x18ListAppointmentsResponse\x12R\n" +
	"\fappointments\x18\x01 \x03(\v2..appointment_service.proto.AppointmentResponseR\fappointments2\xfa\x03\n" +
	"\x12AppointmentService\x12x\n" +
	"\x11CreateAppointment\x123.appointment_service.proto.CreateAppointmentRequest\x1a..appointment_service.proto.AppointmentResponse\x12r\n" +
	"\x0eGetAppointment\x120.appointment_service.proto.GetAppointmentRequest\x1a..appointment_service.proto.AppointmentResponse\x12{\n" +
	"\x10ListAppointments\x122.appointment_service.proto.ListAppointmentsRequest\x1a3.appointment_service.proto.ListAppointmentsResponse\x12y\n" +
	"\x17UpdateAppointmentStatus\x12..appointment_service.proto.UpdateStatusRequest\x1a..appointment_service.proto.AppointmentResponseBMZKgithub.com/CoffeeSi/golang2AITU/assignment2/appointment-service/proto;protob\x06proto3"
...
var file_appointment_proto_goTypes = []any{
	(*CreateAppointmentRequest)(nil), // 0: appointment_service.proto.CreateAppointmentRequest
	(*GetAppointmentRequest)(nil),    // 1: appointment_service.proto.GetAppointmentRequest
	(*ListAppointmentsRequest)(nil),  // 2: appointment_service.proto.ListAppointmentsRequest
	(*UpdateStatusRequest)(nil),      // 3: appointment_service.proto.UpdateStatusRequest
	(*AppointmentResponse)(nil),      // 4: appointment_service.proto.AppointmentResponse
	(*ListAppointmentsResponse)(nil), // 5: appointment_service.proto.ListAppointmentsResponse
}
var file_appointment_proto_depIdxs = []int32{
	4, // 0: appointment_service.proto.ListAppointmentsResponse.appointments:type_name -> appointment_service.proto.AppointmentResponse
	0, // 1: appointment_service.proto.AppointmentService.CreateAppointment:input_type -> appointment_service.proto.CreateAppointmentRequest
	1, // 2: appointment_service.proto.AppointmentService.GetAppointment:input_type -> appointment_service.proto.GetAppointmentRequest
	2, // 3: appointment_service.proto.AppointmentService.ListAppointments:input_type -> appointment_service.proto.ListAppointmentsRequest
	3, // 4: appointment_service.proto.AppointmentService.UpdateAppointmentStatus:input_type -> appointment_service.proto.UpdateStatusRequest
	4, // 5: appointment_service.proto.AppointmentService.CreateAppointment:output_type -> appointment_service.proto.AppointmentResponse
	4, // 6: appointment_service.proto.AppointmentService.GetAppointment:output_type -> appointment_service.proto.AppointmentResponse
	5, // 7: appointment_service.proto.AppointmentService.ListAppointments:output_type -> appointment_service.proto.ListAppointmentsResponse
	4, // 8: appointment_service.proto.AppointmentService.UpdateAppointmentStatus:output_type -> appointment_service.proto.AppointmentResponse
